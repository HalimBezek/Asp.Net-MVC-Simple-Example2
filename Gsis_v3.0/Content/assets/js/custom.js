	...
	$(document).ready(function(){
		...
		$("#contact-form").validate({
			...
			messages: {
				...
				email: {
				    required: "Gerekli Alan!",
					email: "Lutfen Gecerli Mail Adresi Girin!"
				},
				konu: {
				    required: "Gerekli Alan!"
				},
			...
			submitHandler: function(form) {
				...
				$(form).ajaxSubmit({
					...
					success: function(msg) {
						...
						if (msg == 'OK') {
							result = '<div class="alert alert-success">Mesaj Gonderildi!</div>';
					...
					error: function() {
						...
						result = '<div class="alert alert-danger">Mesaj Gonderilirken Hata Olustu!</div>';
						$("#alert-area").html(result);
